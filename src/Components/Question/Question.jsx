  ...
  return (
    <div className="questioncontainer" >
        <div className='Question'   id="outquestion">
            {props.number!=0&&<div className='back' onClick={()=>{
            const previous = props.number-1;
            document.getElementById("outquestion").className="animatepreviousback Question"
            ...
            <button className="button-74" onClick={()=>{
                ...
                document.getElementById("outquestion").className="animateprevious Question"
